...
These posterior predictive checks show that the fake data drawn from the posterior distribution resemble and include the observed data. A histogram of simulated standard deviations compared with the standard deviation of the observed data is included to show how another property of the sampled data compares with the observation.
